...
<div class="bg-light">
    <div class="container py-5">
        <div class="row h-100 align-items-center py-5">
            ...
            <div class="chef col-lg-6 d-none d-lg-block"><img src="../img/ogs.png" alt=""  class="img-fluid mb-4 mb-lg-0"></div>
        </div>
    </div>
</div>
    ...
    <div class="container py-5">
        <div class="row align-items-center mb-5">
            <div class="col-lg-6 order-2 order-lg-1"><i class="fa fa-bar-chart fa-2x mb-3 text-primary"></i>
                ...
                <p class="font-italic text-muted mb-4">As veterans, we understand the importance of fueling your body with food that is both delicious and nutritious.</p><a href="/foodlister" class="btn btn-light px-5 rounded-pill shadow-sm">View our dishes</a>
            </div>
            <div class="col-lg-5 px-5 mx-auto order-1 order-lg-2"><img src="../img/workout.png" alt="" class="img-fluid mb-4 mb-lg-0"></div>
        </div>
    ...
    <div class="container py-5">
        ...
        <div class="row text-center">
            ...
            <div class="col-xl-3 col-sm-6 mb-5">
                <div class="bg-white rounded shadow-sm py-5 px-4"><img src="../img/sergprofile.png" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
            ...
            <!-- Team item-->
            <div class="col-xl-3 col-sm-6 mb-5">
                <div class="bg-white rounded shadow-sm py-5 px-4"><img src="../img/michaelprofile.png" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
